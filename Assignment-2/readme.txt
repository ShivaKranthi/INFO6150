...
I have created two external files named: html.css and gal.css 
I have imported the same files in the index.html file
...
Added position relative to flex div in the column direction for image.
Added position absolute proprty inside the text to show it at the right location


5	use of tel, mailto option for contact information 
In the contact section, I have used both attributes and user can email me if they want to contact me.
