      ...
      <div className="Cgfilter">
        ...
        <div className="filters">
          <ul>
            ...
            <Link className="lined" to="?cg=Computers">
              Computers
            </Link>
            <Link className="lined" to="?cg=Phones">
              Phones
            </Link>
            <Link className="lined" to="?cg=Earphones">
              Earphones
            </Link>
            <Link className="lined" to="?cg=Watches">
              Watches
            </Link>
            <Link className="lined" to="?cg=Repairs">
              Repairs
            </Link>
            <Link className="lined" to="?cg=Others">
              Others
            </Link>
